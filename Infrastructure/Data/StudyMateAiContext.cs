...
using StudyMateIA.Domain.Entities;

namespace StudyMateIA.Infrastructure.Data;

public partial class StudyMateAiContext : DbContext
{
    public StudyMateAiContext()
    {
    }

    public StudyMateAiContext(DbContextOptions<StudyMateAiContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Summary>(entity =>
        {
            ...
            entity.Property(e => e.RegenerationCount).HasDefaultValueSql("'0'");
